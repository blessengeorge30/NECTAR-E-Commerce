        ...
        <View style={styles.container}>
            <ImageBackground blurRadius={8} source={require('../assets/blurbg.jpeg')}
                ...
                <View style={{ marginTop: 20, alignItems: 'center', alignSelf: 'center' }}>
                    <View >
                        <Text style={{ color: 'black', fontSize: 26,fontWeight: 'bold', alignSelf:"center",marginBottom: -5 }}>Your Items </Text>
                        <Text style={{ color: 'black', fontSize: 25, fontWeight: 'bold' ,marginLeft: -5, marginBottom: 15 }}>has added to your Cart ! 🛒</Text>
