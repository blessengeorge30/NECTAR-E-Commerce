...
import { PRODUCT_BEVERAGES } from "../Components/DiscoverBeverages";
                ...
                <View style={{ flex: 1 }}>
                    <ImageBackground source={require('../assets/blurbg.jpeg')}
                        ...
                        <View style={{ marginTop: 90, flexDirection: 'row' }}>
                            ...
                            <Text style={{ color: 'black', fontSize: 22, marginBottom: 12, alignSelf: "center", marginLeft: 55,marginVertical:5, fontWeight: "bold" }}>Beverages 123456789</Text>
